...
<%
					...
					if(openerFrame.equals("frameDetails")){	
%>												
						var frameDetails = null;
						frameDetails = getFormContentFrame().document.getElementById("frameDetails");
						frameDetails.src = frameDetails.src;
							//frameDetails.src = "../common/emxIndentedTable.jsp?program=emxTask:getAssignAndActiveRelatedIssue,emxTask:getReviewRelatedIssue,emxTask:getClosedRelatedIssue&programLabel=emxFramework.Common.AssignAndActive,emxFramework.Common.Review,emxFramework.Common.Closed&showPageHeader=true&header=emxFramework.Common.MyCountermeasureIssues&table=SEMIssueInfo&toolbar=AssignIssueToolbar&sortColumnName=EstFinishDate&sortDirection=ascending&Export=false&HelpMarker=emxhelpassignmentsummary&editLink=true&selection=multiple&postProcessJPO=emxWeeklyTimeSheet:postProcessRefresh&editable=true&suiteKey=Framework";						
<%
					}else{
%>						
