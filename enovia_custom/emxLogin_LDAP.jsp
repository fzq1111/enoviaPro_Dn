...
<%
//add by ryan 2017-01-01
boolean bEnableLDAP = true;
if(bEnableLDAP)
{
	response.setHeader("WWW-Authenticate","FORM");
}
//add end
//JPA+
...
%>
    ...
    function handleOnLoad() {
        ...
        //get pointer to the form
		 ...
		 var bEnableLDAP =  <%=bEnableLDAP%>;//add by ryan 2017-01-01
	     // set default methods for events
		 //modify by ryan 2017-01-01
		 if(bEnableLDAP)
		 {
			 objForm.j_username.onkeypress = submitFunction;
			 objForm.j_password.onkeypress = submitFunction;		 
			 objForm.j_username.focus();
		 }
		 else
		 {
...
{
%>
                         <span><input type="text" name="j_username" size="30"/></span>
<%
}
else
{
...
{
%>
                         <span><input name="j_password" size="30" type="password"/></span>
<%
}
else
{
