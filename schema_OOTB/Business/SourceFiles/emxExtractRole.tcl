...
#
   ...
   set sFile "Role Name\tRegistry Name\tDescription\tParent Roles (use \"|\" delim)\tChild Roles (use \"|\" delim)\tAssignments (use \"|\" delim)\tSite\tHidden (boolean)\tRole Type (Project/Org)\tIcon File\n"
...
#                  append sFile "$sName$sMultiline\t$sOrigName\t$sDescription\t$slsParentRole\t$sChildRole\t$sAssignment\t$sSite\t$bHidden\n"
                  append sFile "$sName$sMultiline\t$sOrigName\t$sDescription\t$slsParentRole\t$sChildRole\t\t$sSite\t$bHidden\t$sProjOrg\n"
                  set bFirst FALSE
               } else {
