#################################################################################
#
# $RCSfile: C3DAdminNameChange.tcl.rca $ $Revision: 1.5 $
#
# Description:
...
#################################################################################
#                                                                               #
#   Copyright (c) 1998-2011 Dassault Systemes.  All Rights Reserved.                   #
...
###############################################################################
    ...
    # Get admin type
     ...
     set sNewObjectName        [lindex [split $sNewProperty "_"] 1]
    ...
    if {$mqlret != 0} {
        ...
        mql trace type INSTALL text ">ERROR       : C3DAdminNameChange.tcl"
