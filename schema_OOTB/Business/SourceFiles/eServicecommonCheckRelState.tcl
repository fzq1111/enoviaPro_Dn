   ...
   # till here For bug 307577
              ...
              if {[string compare "$sChildPolicy"  "$sDvlpPartPolicy"] != 0} {
                ...
                if {$mqlret == 0} {
					...
					set i18ChildState [mql execute program emxLifecycle -method getI18State  \
                                               "$sChildPolicy" \
                                               "$sChildState" \
                           ]

                    set i18TargetState [mql execute program emxLifecycle -method getI18State  \
                                               "$sChildPolicy" \
                                               "$sTargetState" \
                               ]
