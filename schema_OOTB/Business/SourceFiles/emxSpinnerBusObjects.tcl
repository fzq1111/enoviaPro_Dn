...
# 361693 (Revision Chain) - MJO - 10/9/2008
            #KYB Start V6R2013x Removed 1234 errors
			#if {[string first "Previous Type" $sLine] == 14} {
             #  set bRevision TRUE
            #} 
			
			#if {[string first "Previous Rev" $sLine] == 14} {
            #   set bRevision TRUE
            #} elseif {[string first "Previous Type" $sLine] == 14} {
			#	set bRevision FALSE
            #}
			...
			#KYB End V6R2013x Removed 1234 errors
