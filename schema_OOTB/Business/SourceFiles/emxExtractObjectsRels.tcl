#*******************************************************************************
# @progdoc        emxExtractObjectsRels.tcl v10.9
#
...
# END
                  ...
                  if { [ catch { eval $sCmd } sOutstr ] == 0 } {
                     ...
                     if {$sOutstr != ""} {
                        if {!$bExternal} {
                           ...
                           if {$bRevision} {
							  #KYB Fixed SCR-0000744 - Renamed following columns
							  #1)from 'Previous Type' to 'New Name'
							  #2)from 'Previous Name' to 'New Rev'
                              #set lBos "Type\tName\tRev\tPrevious Rev\tPrevious Type\tPrevious Name\tPolicy\tState\tVault\tOwner\tdescription$sFormattedAttributeList"
							  set lBos "Type\tName\tRev\tPrevious Rev\tNew Name\tNew Rev\tPolicy\tState\tVault\tOwner\tdescription$sFormattedAttributeList"
                           } else {
                              #set lBos "Type\tName\tRev\tPrevious Type\tPrevious Name\tPolicy\tState\tVault\tOwner\tdescription$sFormattedAttributeList"
         ...
         if {$bExternal} {
            ...
            set p_file [open $p_filename w]
            puts $p_file "Type\tName\tRev\tNew Name\tNew Rev\tPolicy\tState\tVault\tOwner\tdescription$sFormattedAttributeList"
            puts $p_file "$lBos"
            close $p_file
         }
      }
